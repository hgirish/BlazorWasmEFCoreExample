...
namespace ContactsApp.Repository
{
    ...
    public class UnitOfWork<TContext, TEntity> :
        IUnitOfWork<TEntity> where TContext : DbContext, ISupportUser
    {
        /// <summary>
        ...
        /// </summary>
        public IBasicRepository<TEntity> Repo { get => _repo; }
        /// <summary>
        /// Commit changes.
        /// </summary>
        ...
        public async  Task CommitAsync()
        {
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                else
                {
                    ...
                    newEx.RowVersion = dbValues.GetValue<byte[]>(ContactContext.RowVersion);
