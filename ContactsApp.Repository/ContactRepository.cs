...
namespace ContactsApp.Repository
{
    ...
    public class ContactRepository : IRepository<Contact, ContactContext>
    {
        ...
        public async  Task<TPropertyType> GetPropertyValueAsync<TPropertyType>(Contact item, string propertyName)
        {
        ...
        public async Task<Contact> LoadAsync(int id, ClaimsPrincipal user, bool forUpdate = false)
        {
            ...
            await WorkInContextAsync(async context =>
            {
                ...
                contact = await contactRef.SingleOrDefaultAsync(c => c.Id == id);
            }, user);
            return contact;
        }
        /// <summary>
        ...
        /// <returns>A <see cref="Task"/>.</returns>
        public async  Task SetOriginalValueForConcurrencyAsync<TPropertyType>(Contact item, string propertyName, TPropertyType value)
        {
            await WorkInContextAsync(context =>
            {
            ...
            bool saveChanges = false)
        {
            if (PersistedContext != null)
            {
                ...
                // do some work, save changes flag is ignored because
                // this will be commited later
